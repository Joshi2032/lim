...
export class MenuItemsEffects {
  ...
  constructor(
    ...
    this.loadMenuItems$ = createEffect(() =>
      this.actions$.pipe(
    ...
    this.loadMenuItemsByCategory$ = createEffect(() =>
      this.actions$.pipe(
    ...
    this.createMenuItem$ = createEffect(() =>
      this.actions$.pipe(
    ...
    this.updateMenuItem$ = createEffect(() =>
      this.actions$.pipe(
    ...
    this.deleteMenuItem$ = createEffect(() =>
      this.actions$.pipe(
